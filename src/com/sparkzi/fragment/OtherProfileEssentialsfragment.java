...
import com.sparkzi.adapter.OtherProfileEssentialAdapter;
...
public class OtherProfileEssentialsfragment extends ListFragment {
	...
	private OtherProfileEssentialAdapter pEssentialAdapter;

	public static List<Essential> eList;

	public OtherProfileEssentialsfragment() {
	}

	public static OtherProfileEssentialsfragment newInstance(String userName) {
		OtherProfileEssentialsfragment fragment = new OtherProfileEssentialsfragment();
		uName = userName;
		return fragment;
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		pEssentialAdapter = new OtherProfileEssentialAdapter(activity, null);
