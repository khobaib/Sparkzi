...
public class EssentialDetailsActivity extends Activity implements OnItemSelectedListener{
            ...
            if(responseObj != null){
                try {
                    ...
                    if(status.equals("OK")){
                        ...
                        generateSpinner(sEducation, essentialValueList[Constants.ESSENTIAL_EDUCATION_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_EDUCATION_INDEX].size()]));
                        generateSpinner(sEthnicity, essentialValueList[Constants.ESSENTIAL_ETHNICITY_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_ETHNICITY_INDEX].size()]));
                        generateSpinner(sDiet, essentialValueList[Constants.ESSENTIAL_DIET_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_DIET_INDEX].size()]));
                        generateSpinner(sDrinks, essentialValueList[Constants.ESSENTIAL_DRINKS_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_DRINKS_INDEX].size()]));
                        generateSpinner(sSmokes, essentialValueList[Constants.ESSENTIAL_SMOKES_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_SMOKES_INDEX].size()]));
                        generateSpinner(sReligion, essentialValueList[Constants.ESSENTIAL_RELIGION_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_RELIGION_INDEX].size()]));
                        generateSpinner(sKids, essentialValueList[Constants.ESSENTIAL_KIDS_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_KIDS_INDEX].size()]));
                        generateSpinner(sPolitics, essentialValueList[Constants.ESSENTIAL_POLITICS_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_POLITICS_INDEX].size()]));
                        generateSpinner(sSign, essentialValueList[Constants.ESSENTIAL_SIGN_INDEX].toArray(new String[essentialValueList[Constants.ESSENTIAL_SIGN_INDEX].size()]));
    ...
    private int getEssentialIndexFromValue(List<Essential> thisEssentialList, String value){
        ...
        return 0;           // by-default the first position of the spinner will be selected
    }


    private void generateSpinner(Spinner spinner, String[] arrayToSpinner) {
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(
                EssentialDetailsActivity.this, R.layout.my_simple_spinner_item, arrayToSpinner);
