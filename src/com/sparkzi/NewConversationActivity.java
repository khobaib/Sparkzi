...
public class NewConversationActivity extends Activity {
			...
			if (responseObj != null) {
				try {
					...
					if (status.equals("OK")) {
						...
						ArrayAdapter<String> favoriteListAdapter = new ArrayAdapter<String>(
								NewConversationActivity.this, R.layout.my_simple_spinner_item, favoriteUserNameList);
	...
	public class SendMessageToServer extends AsyncTask<Void, Void, JSONObject> {
		...
		protected JSONObject doInBackground(Void... params) {
			...
			// urlParam.add(new BasicNameValuePair("user", email.substring(0,
			// email.lastIndexOf("@"))));
	...
	void alert(String message, final Boolean success) {
		...
		bld.setNeutralButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (success) {
					// Intent i = new Intent(NewConversationActivity.this,
					// LoginActivity.class);
